import tarimBakani from "../../public/ministers/tarim.png";
        ...
        answers: [
            {
                ...
                effect: {
                    ...
                    foodPrices: -20,  // Gıda fiyatları dengelenir
                    budget: -25,  // Büyük bütçe ayrılması gerekir
                    shortTermCosts: -15  // Kısa vadede maliyet yüksek olur
                }
            },
            {
                text: "Şu an başka önceliklerimiz var, bu krizi düşük maliyetli çözümlerle yönetelim.",
                effect: {
                    agriculturalProduction: -15,  // Tarımsal üretim düşmeye devam eder
                    foodPrices: +20,  // Gıda fiyatları yükselir
                    budget: +10,  // Kısa vadede maliyet düşük tutulur
                    longTermImpact: -20  // Uzun vadede olumsuz etkiler artar
                }
            }
        ],

...
export const events = [
    {
        id: 500,
        photo: alienInvasion,
        title: "Uzaylı İstilası Başladı!",
        description: "Şehir merkezine tanımlanamayan bir uzay gemisi indi, sokaklarda garip yaratıklar dolaşıyor! Halk panik içinde, hükümetler alarma geçti. İnsanlık nasıl bir yanıt verecek?",
    },
    {
        id: 501,
        photo: arabMoney,
    ...
    },
    {
        ...
        description: "Halk hükümete karşı ayaklanıyor, meydanlarda protestolar büyüyor! Talepler karşılanacak mı?",
    },
    {
        id: 511,
        photo: shakiraConcert,
        title: "Stadyumda Shakira Coşkusu!",
        description: "Shakira stadyumda unutulmaz bir konser veriyor! Hayranlar coşkuyla eğlenirken, etkinlik tüm ülke gündeminde.",
    },
    {
        id: 512,
    ...
    },
    {
        ...
        description: "Çiftlik Bank sahibi halkı dolandırdı, birçok kişi birikimlerini kaybetti. Skandal ülke gündeminde büyük yankı uyandırıyor.",
    },
    {
        id: 515,
    ...
    },
    {
        ...
        description: "Milletvekillerine daha ucuza satılan menüler halkın tepkisini çekiyor. İsraf tartışmaları yeniden alevleniyor.",
    },

    {
        id: 520,
        photo: togg,
        title: "Yerli Otomobil Yola Çıkıyor!",
        description: "Türkiye’nin yerli otomobili nihayet yollarda! Halk, gururla ilk yerli üretimi selamlıyor, ancak fiyatlar tartışma konusu",
    },
    {
        id: 521,
        photo: droughtLake,
    ...
    },
    {
        ...
        description: "Türkiye, Suriye’deki iç savaşa müdahale ediyor. Halkın desteğiyle başlayan operasyonlar, uluslararası arenada tartışma yaratıyor.",
    },
    {
        id: 526,
        photo: tbmmVote,
        title: "Narin Cinayetinin soruşturulma önergesi AKP ve MHP oylarıyla reddedildi!",
        description: "Türkiye Büyük Millet Meclisi’nde CHP’li vekillerin, İstanbul’da 27 yaşındaki Narin Cinayetinin soruşturulması için verdiği araştırma önergesi AKP ve MHP oylarıyla reddedildi. CHP’li vekiller, oylama sonrası Meclis’i terk etti.",
    },
    {
        id: 526,
        photo: tbmmFight,

...
const PrivacyPolicy = () => {
    return (
        <div className="min-h-screen bg-gray-50 py-10 px-5 md:px-20 lg:px-40">
            <div className="bg-white shadow-lg rounded-lg p-8">
                <h1 className="text-3xl font-bold text-gray-800 mb-6">Privacy Policy</h1>
                <p className="text-gray-600 mb-4">Last updated: <span className="font-medium">January 08, 2025</span></p>
                ...
                <ul className="list-disc list-inside text-gray-600 mb-6">
                    <li><span className="font-medium">Account:</span> A unique account created for You to access our Service or parts of our Service.</li>
                    <li><span className="font-medium">Affiliate:</span> An entity that controls, is controlled by or is under common control with a party, where &quot;control&quot; means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
                    <li><span className="font-medium">Application:</span> Refers to President Simulator, the software program provided by the Company.</li>
                    <li><span className="font-medium">Application:</span> Refers to President Simulator, the software program provided by the Company.</li>
                    <li><span className="font-medium">Company (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement):</span> refers to President Simulator.</li>
                    <li><span className="font-medium">Country:</span> refers to: Turkey</li>
                    ...
                    <li><span className="font-medium">Usage Data: </span>refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).
                ...
                <h3 className="text-xl font-medium text-gray-700 mb-2">Personal Data</h3>
                <p className="text-gray-600 mb-4">
                ...
                <p className="text-gray-600 mb-4">The Company may use Personal Data for the following purposes:
                </p>
                <ul className="list-disc list-inside text-gray-600 mb-6">
                ...
                <p className="text-gray-600 mb-4">You have the right to delete or request that We assist in deleting the Personal Data that We have collected about You.
                ...
                <h2 className="text-2xl font-semibold text-gray-800 mb-4">Business Transactions</h2>
                <p className="text-gray-600 mb-4">If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
                <h2 className="text-2xl font-semibold text-gray-800 mb-4">Law enforcement</h2>
                <p className="text-gray-600 mb-4">Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
                <h2 className="text-2xl font-semibold text-gray-800 mb-4">Other legal requirements</h2>
                <p className="text-gray-600 mb-4">The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
                <ul className="list-disc list-inside text-gray-600 mb-6">
                ...
                <p className="text-gray-600 mb-4">Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party&apos;s site. We strongly advise You to review the Privacy Policy of every site You visit.
                ...
                <p className="text-gray-600 mb-4">We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page.

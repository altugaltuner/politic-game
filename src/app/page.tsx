...
export default function HomePage() {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center text-center h-auto sm:p-3 p-1 relative sm:gap-4 gap-1">
      ...
      <div className="h-auto md:h-[90%] lg:w-[90%] w-full flex flex-col md:gap-3 gap-2 justify-around items-center bg-white sm:p-3 p-1 rounded-3xl border-[5px] border-black">
      ...
      <Header />
      <div className="h-auto md:h-[90%] lg:w-[90%] w-full flex flex-col md:gap-3 gap-2 justify-around items-center bg-white sm:p-5 p-2 rounded-3xl border-[5px] border-black mb-[80px]">

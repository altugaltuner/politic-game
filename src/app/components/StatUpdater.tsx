    ...
    return (
        <div className="flex w-full md:gap-2 gap-2 sm:rounded-t-lg justify-center p-2 border-black bg-white border-[3px] sm:rounded-xl rounded lg:w-[1150px]">
            ...
            <div className="flex flex-col items-center justify-between sm:p-2 border-black border-[2px] sm:rounded-xl w-[15%] text-center bg-[rgb(220,255,222)] sm:h-[150px] h-[80px]">
                ...
                <div className="flex w-full h-20 relative sm:border-[2px] overflow-hidden sm:mt-2 sm:rounded justify-center items-center bg-[rgb(150,150,150)] border-black border-[1px]">
                    ...
                    />
                    <Image src={agricultureIcon} alt="Agriculture" width={60} height={60} className={`${agriculture < 1 ? 'hidden' : ''} z-10 sm:w-[55px] sm:h-[55px] w-8 h-8 `} />
                </div>
            </div>

            <div className="flex flex-col items-center justify-between sm:p-2 border-black border-[2px] sm:rounded-xl w-[15%] text-center bg-[rgb(255,243,224)] sm:h-[150px] h-[80px]">
                <span className="md:text-sm sm:text-xs sm:block hidden">Altyapı</span>
                <div className="flex w-full h-20 sm:border-[2px] border-black relative overflow-hidden sm:mt-2 sm:rounded justify-center items-center bg-[rgb(150,150,150)]">
                    ...
                    />
                    <Image src={infrastructureIcon} alt="Infrastructure" width={70} height={70} className={`${infrastructure < 1 ? 'hidden' : ''} z-10 sm:w-[55px] sm:h-[55px] w-8 h-8`} />
                </div>
            </div>

            <div className=" flex flex-col items-center justify-between sm:p-2 border-black border-[2px] sm:rounded-xl w-[15%] text-center bg-[#ffe3e0] sm:h-[150px] h-[80px]">
                ...
                <div className="flex w-full h-20 sm:border-[2px] border-black relative overflow-hidden sm:mt-2 sm:rounded justify-center items-center bg-[rgb(150,150,150)]">
                    ...
                    />
                    <Image src={internalSecurityIcon} alt="internalSecurity" width={65} height={65} className={`${internalSecurity < 1 ? 'hidden' : ''} z-10 sm:w-[55px] sm:h-[55px] w-8 h-8`} />
                </div>
            </div>

            <div className=" flex flex-col items-center justify-between sm:p-2 border-black border-[2px] sm:rounded-xl w-[15%] text-center bg-[#faddff] sm:h-[150px] h-[80px]">
                ...
                <div className="flex w-full h-20 sm:border-[2px] border-black relative overflow-hidden sm:mt-2 sm:rounded justify-center items-center bg-[rgb(150,150,150)]">
                    ...
                    />
                    <Image src={internationalIcon} alt="international" width={60} height={60} className={`${international < 1 ? 'hidden' : ''} z-10 sm:w-[55px] sm:h-[55px] w-8 h-8`} />
                </div>
            </div>

            <div className=" flex flex-col items-center justify-between sm:p-2 border-black border-[2px] sm:rounded-xl w-[15%] text-center bg-[#d5f9ff] sm:h-[150px] h-[80px]">
                ...
                <div className="flex w-full h-20 sm:border-[2px] border-black relative overflow-hidden sm:mt-2 sm:rounded justify-center items-center bg-[rgb(150,150,150)]">
                    ...
                    />
                    <Image src={currencyIcon} alt="Currency" width={45} height={45} className={`${currency < 1 ? 'hidden' : ''} z-10 sm:w-[55px] sm:h-[55px] w-8 h-8`} />
                </div>
            </div>

            <div className=" flex flex-col items-center justify-between sm:p-2 border-black border-[2px] sm:rounded-xl w-[15%] text-center bg-[#d9dfff] sm:h-[150px] h-[80px]">
                ...
                <div className="flex w-full h-20 sm:border-[2px] border-black relative overflow-hidden sm:mt-2 sm:rounded justify-center items-center bg-[rgb(150,150,150)]">
                    ...
                    />
                    <Image src={publicSupportIcon} alt="Public Opinion" width={65} height={65} className={`${publicSupport < 1 ? 'hidden' : ''} z-10 sm:w-[55px] sm:h-[55px] w-8 h-8`} />
                </div>
            </div>

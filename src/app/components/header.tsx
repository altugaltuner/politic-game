        ...
        <div className="h-auto md:h-[90%] lg:w-[90%] w-full justify-around items-center bg-white sm:p-3 p-2 rounded-3xl border-[5px] border-black">
            <div className='flex lg:flex-row flex-col justify-center items-start md:gap-3 gap-1'>
                <div className='flex flex-col sm:gap-3 gap-1 lg:w-[28%] w-full p-1 rounded-lg'>
                    ...
                    <p className='2xl:text-[30px] xl:text-[24px] lg:text-[20px] text-[18px]'>Cumhurbaşkanı simülatöre hoşgeldin! Bakanlar ve politikacılarla istişare ederek vereceğin kararlara göre ülkenin kaderini sen belirleyeceksin. <br /><br /> Ülkenin güvenliğinden dış politikaya, tarımdan altyapı hizmetlerine kadar her şey senin elinde!</p>
                </div>

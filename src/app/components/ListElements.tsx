...
const ListElements: React.FC<ListElementsProps> = ({ selectedListIDs }) => {
    ...
    return (
        <div ref={scrollRef} className={` ${isDarkMode ? 'border-white bg-[rgb(17,17,17)] text-white' : 'border-black bg-white text-black'} text-center border-[3px] xl:order-2 order-1  rounded-lg sm:p-3 p-2 w-[100%] max-h-[900px] `}>

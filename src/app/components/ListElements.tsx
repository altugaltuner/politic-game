...
const ListElements = () => {
    ...
    return (
        <div className=" text-center border-2 border-black rounded-lg p-3 w-[22%] max-h-[900px] bg-white">
            ...
            <ScrollArea className=" w-full rounded-md p-2 max-h-[800px] overflow-y-auto">
                {elements.map(element => (
                    <div key={element.id} className="p-2 border-[1px] rounded-xl border-black bg-white mb-3">
